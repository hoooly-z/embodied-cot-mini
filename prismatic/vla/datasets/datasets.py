...
class RLDSBatchTransform:
    ...
    def __call__(self, rlds_batch: Dict[str, Any]) -> Dict[str, Any]:
        ...
        reasoning, _subset = reasoning_dropout(rlds_batch["reasoning"].decode(), dropout_prob=self.reasoning_dropout_prob)
        ...
        answer_text = f"{reasoning} {CotTag.ACTION.value} {self.action_tokenizer(action)}"
        raw_action_tokens = self.base_tokenizer(answer_text)["input_ids"]
